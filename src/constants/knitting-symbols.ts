...
export const knittingSymbols: KnittingSymbol[] = [
	...
	{ id: 'sssk', abbr: 'sssk', name: '오른코 중심 3코 모아뜨기', category: 'special', patternType: 'knitting', icon: '' },
	{ id: 'k3tog', abbr: 'k3tog', name: '왼코 중심 3코 모아뜨기', category: 'special', patternType: 'knitting', icon: '' },
...
export const crochetSymbols: KnittingSymbol[] = [
	...
	{ id: 'sl-st', abbr: 'sl st', name: '빼뜨기', category: 'basic-structure', patternType: 'crochet', icon: '' },
	// 기본뜨기
	{ id: 'sc', abbr: 'sc', name: '짧은뜨기', category: 'basic-stitch', patternType: 'crochet', icon: '' },
	{ id: 'hdc', abbr: 'hdc', name: '중긴뜨기', category: 'basic-stitch', patternType: 'crochet', icon: '' },
	{ id: 'dc', abbr: 'dc', name: '긴뜨기', category: 'basic-stitch', patternType: 'crochet', icon: '' },
	...
	// 늘리기
	{ id: 'sc-inc', abbr: 'sc inc', name: '짧은뜨기 늘리기', category: 'increase', patternType: 'crochet', icon: '' },
	{ id: 'dc-inc', abbr: 'dc inc', name: '긴뜨기 늘리기', category: 'increase', patternType: 'crochet', icon: '' },
	// 줄이기
	{ id: 'sc2tog', abbr: 'sc2tog', name: '짧은뜨기 모아뜨기', category: 'decrease', patternType: 'crochet', icon: '' },
	{ id: 'dc2tog', abbr: 'dc2tog', name: '긴뜨기 모아뜨기', category: 'decrease', patternType: 'crochet', icon: '' },
	// 특수뜨기
	{ id: 'popcorn', abbr: 'pop', name: '팝콘뜨기', category: 'special', patternType: 'crochet', icon: '' },
	{ id: 'bobble', abbr: 'bob', name: '버블뜨기', category: 'special', patternType: 'crochet', icon: '' },
	{ id: 'shell', abbr: 'sh', name: '구슬뜨기', category: 'special', patternType: 'crochet', icon: '' },
