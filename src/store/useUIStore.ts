...
export const useUIStore = create<UIState>((set) => ({
	...
	setSelectedSymbol: (symbol) =>
		set(
			symbol !== null
				? { selectedSymbol: symbol, selectedColor: null, isColorMode: false, isShapeGuideDrawMode: false, isShapeGuideEraseMode: false, isSelectionMode: false, cellSelection: null, isAnnotationMode: false, annotationPopover: null }
				: { selectedSymbol: null },
		),
