...
const FEATURES = [
	{
		title: '직관적인 그리드 편집',
		description: '셀 클릭·드래그 한 번으로 뜨개 기호를 배치합니다. 복잡한 도구 없이 바로 시작하세요.',
	},
	{
		title: '다양한 뜨개 기호 지원',
		description: '대바늘·코바늘 국제 표준 기호를 모두 지원합니다.',
	},
	{
		title: 'PDF 출력',
		description: '완성된 도안을 PDF로 저장하거나 바로 인쇄할 수 있습니다. A4 용지에 최적화됩니다.',
	},
	{
		title: '무료·설치 불필요',
...
const FAQS = [
	...
	},
	{
		...
		answer:
			'현재는 PDF 출력으로 저장할 수 있습니다. 브라우저를 닫으면 작업 내용이 초기화되므로 작업이 끝나면 PDF로 저장해 두세요.',
	},
	{
